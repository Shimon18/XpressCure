      ...
      <div>
        <div class="page-wrapper">
          <div class="content">
            <div class="row">
              <div class="col-lg-12">
              <Link to={"/AllMitraDoctors"}><i className="fa fa-arrow-left back_btn"></i></Link>

                <h4 class="page-title">Register New Doctor Mitra</h4>
              </div>
            </div>
            <div class="row">
              <div class="col-lg-12">
                <form>
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        <label>Health Worker Cource Certificate</label>
                        <input
                          name="identity_front_side_img"
                          class="form-control"
                          type="file"
