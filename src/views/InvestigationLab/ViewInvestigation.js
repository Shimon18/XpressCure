...
class ViewInvestigation extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
      ...
      <div>
        <div class="page-wrapper">
          <div class="content">
            <div class="row">
              <div class="col-lg-12">
              <Link to={"/InvestigationLab"}><i className="fa fa-arrow-left back_btn"></i></Link>
                <h4 class="page-title">View Investigation Detail</h4>
              </div>
            </div>
            <div class="row">
              <div class="col-lg-12">
