...
class DoctorMitraCreditPoint extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
      ...
      <div className="page-wrapper">
        ...
        >
          ...
          <div className="col-md-12 d-flex align-items-center justify-content-between">
              ...
              <h4 class="page-title">Doctor Mitra Credit Point Master</h4>
              </div>
            ...
            <Link to={"/AddDoctorMitraCreditPoint"}>
              <Button
                color="info"
                size="sm"
                  ...
                  <td>
                    <Row>
                      <div className="d-flex align-items-center ml-auto mr-auto">
                        <Link to={"./ViewDoctorMitraCreditPoint"}>
                          <Button
                            color="info"
                            size="sm"
...
export default DoctorMitraCreditPoint;
