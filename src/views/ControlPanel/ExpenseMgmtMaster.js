...
class ExpenseMgmtMaster extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
      ...
      <div className="page-wrapper">
        ...
        >
          ...
          <div className="col-md-12 d-flex align-items-center justify-content-between">
              ...
              <h4 class="page-title">Expense Management Master</h4>
              </div>
...
export default ExpenseMgmtMaster;
