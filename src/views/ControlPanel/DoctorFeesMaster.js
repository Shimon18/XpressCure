...
class DoctorFeesMaster extends Component {
    constructor(props) {
        super(props);
        this.state = {  }
    }
            ...
            <div className="page-wrapper">
              ...
              >
                <div className="col-md-5 d-flex align-items-center">
                  <h4 class="page-title">Doctor Fees Master</h4>
                </div>
                <div className="col-md-7 d-flex align-items-center justify-content-end">
                <Link to={"/AddDoctorFeesMaster"}>
                                  <Button
                                    color="info"
                                    size="sm"
                ...
                <Table responsive>
                  <thead>
                    <tr>
                      ...
                      <th>Doctor Sub-Category</th>
                      <th>Doctor Service Charge</th>
                      <th>Action</th>
                    </tr>
                  </thead>
                  <tbody>
...
export default DoctorFeesMaster;