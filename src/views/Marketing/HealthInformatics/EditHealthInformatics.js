...
class EditHealthInformatics extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
      ...
      <div>
        <div class="page-wrapper">
          <div class="content">
            <div class="row">
              <div class="col-lg-12">
              <Link to={"/HealthInformatics"}><i className="fa fa-arrow-left back_btn"></i></Link>
...
export default EditHealthInformatics;
