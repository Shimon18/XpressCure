...
class CurrentMonthRecords extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
      ...
      <div className="page-wrapper">
        ...
        >
          ...
          <div className="col-md-12 d-flex align-items-center justify-content-between">
              ...
              <div>
              <Link to={"/DoctorAccount"}><i className="fa fa-arrow-left back_btn"></i></Link>
              <h4 class="page-title">Current Month Records</h4>
              </div>
...
export default CurrentMonthRecords;
